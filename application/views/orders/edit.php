        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Enter Customer Name" value="<?php echo $order_data['order']['customer_name'] ?>" readonly autocomplete="off"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="Enter Customer Phone" value="<?php echo $order_data['order']['customer_phone'] ?>" readonly autocomplete="off">
                    </div>
                  </div>
                </div>
                    ...
                    <?php if(isset($order_data['order_item'])): ?>
                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       <tr id="row_<?php echo $x; ?>">
                          ...
                          <td><input type="number" name="qty[]" min="1" max="" id="qty_<?php echo $x; ?>" class="form-control" required onchange="getTotal(<?php echo $x; ?>)" value="<?php echo $val['order_qty'] ?>" autocomplete="off" readonly></td>
                          <td>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <select disabled type="text" class="form-control" id="paid_status" name="paid_status">
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'orders/printDiv/'.$order_data['order']['o_id'] ?>" class="btn btn-default" >Print</a>
    ...
    if(id) {
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          mywindow.document.write('<html><head><title>Invoice Details</title>');
               ...
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+ 
                    '<select class="form-control select_group product" data-row-id="'+row_id+'" id="product_'+row_id+'" name="product[]" style="width:100%;" onchange="getProductData('+row_id+')">'+
                      ...
                      html += '</select>'+
                    '</td>'+ 
                    '<td><input type="number" min="1" max="1" value="1" name="qty[]" id="qty_'+row_id+'" class="form-control" onchange="getTotal('+row_id+')"></td>'+
